...
public class ParserTest {
    ...
    public void testSelect() throws Exception {
        String stat = "select * from table where id > 0 and name < 20";
        Object res = Parser.Parse(stat.getBytes());
        Select select = (Select)res;
        ...
        String stat2 = "select name,id from table where id > 0 and name < 20";
        Object res2 = Parser.Parse(stat2.getBytes());
        Select select2 = (Select)res2;

        Gson gson2 = new Gson();
        System.out.println("Select");
        System.out.println(gson.toJson(select2));
        System.out.println("======================");
    }
}
