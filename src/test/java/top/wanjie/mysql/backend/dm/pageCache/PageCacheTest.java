...
public class PageCacheTest {
    ...
    public void testPageCacheMulti() throws InterruptedException {
        pc2 = PageCache.create("/tmp/pcacher_multi_test", PageCache.PAGE_SIZE * 50);
        mpc = PageCache.create("/tmp/pcacher_multi_test2", PageCache.PAGE_SIZE * 50);
        ...
        assert new File("/tmp/pcacher_multi_test2.db").delete();
    }
